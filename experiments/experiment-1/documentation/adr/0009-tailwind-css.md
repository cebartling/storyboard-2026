...
- an `@theme` block defining the palette (`canvas`, `ink`, `ink-muted`, `line`, `brand`,
  `accent`, `danger`) as the app's colour vocabulary,
- `@layer base` defaults for `body`, `h1`, and focus rings,
